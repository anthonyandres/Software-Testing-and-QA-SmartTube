...
public class ProxyEQUALS {
     ...
     *
     */
    public final static ProxyEQUALS NO_PROXY = new ProxyEQUALS();
     ...
     */
    //TEST THIS
    public void Proxy(Type type, SocketAddress sa) {
...
//    }
    ...
    public final boolean equals(Object obj) {
        if (obj == null || !(obj instanceof ProxyEQUALS))
            return false;
        ProxyEQUALS p = (ProxyEQUALS) obj;
        if (p.type() == type()) {
            if (address() == null) {
